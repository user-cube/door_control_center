...
## Flask API
Aqui pode ser encontrado o micro-serviço que permite verificar se um acesso é válido ou não, assim, sempre que um cartão é passado no leitor, o RASP faz um pedido ao path `isValid` que retorna se o acesso é válido ou não.
Os caminhos disponíveis podem ser vistos na home da mesma. - [Documentação](https://ies-controller.herokuapp.com/)
Salientamos que, enquanto micro-serviço, esta apenas tem métodos GET.